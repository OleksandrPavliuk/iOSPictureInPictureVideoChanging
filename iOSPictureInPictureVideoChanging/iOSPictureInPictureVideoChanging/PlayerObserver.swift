...
public final class PlayerObserver: NSObject {
    public struct Callbacks {
        ...
        public var durationChanged: Action<(duration: CMTime, forItem: AVPlayerItem)>?
    ...
    public init(callbacks: Callbacks, player: AVPlayer) {
        ...
        removeObserver = { playerObserver in
            ...
            currentItem.removeObserver(playerObserver, forKeyPath: "duration", context: &Context.item)
        ...
        case &Context.item:
            ...
            if keyPath == "duration" {
                if let newDurationAsValue = change[NSKeyValueChangeKey.newKey] as? NSValue {
                    ...
                    callbacks.durationChanged?(duration: newDuration, forItem: item)
                }
                else {
                    callbacks.durationChanged?(duration: kCMTimeZero, forItem: item)
                }
